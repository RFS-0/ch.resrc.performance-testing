...
public class BasicBubbleSorter implements Sorter {
    ...
    private <T extends Comparable<T>> void swap(List<T> toBeSwapped, int indexOfElement, int indexOfOtherElement) {
