...
public class OptimizedBubbleSortSimulation extends Simulation {
    ...
    ScenarioBuilder basicBubbleSortScenario = scenario("Optimized Bubble Sort")
            .exec(
                    repeat(2, sortResource.request("/optimized-bubble-sort", 1)),
                    repeat(2, sortResource.request("/optimized-bubble-sort", 10)),
                    repeat(2, sortResource.request("/optimized-bubble-sort", 100)),
                    repeat(2, sortResource.request("/optimized-bubble-sort", 1_000)),
                    repeat(2, sortResource.request("/optimized-bubble-sort", 10_000))
            );
